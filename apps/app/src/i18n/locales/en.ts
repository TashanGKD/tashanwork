...
export default {
  ...
  "composer.agent_label": "Agent mode",
  "composer.agent_selected": "Agent mode set to {agent}.",
  "composer.agent_selected_default": "Agent mode reset to default.",
  "composer.agents_label": "Agent modes",
  ...
  "extensions.app_count_one": "{count} 工具能力已连接",
  "extensions.app_count_other": "{count} 个工具能力已连接",
  "extensions.apps_mcp_header": "工具能力（MCP）",
  "extensions.filter_all": "All",
  "extensions.filter_apps": "工具能力",
  "extensions.filter_plugins": "数字员工",
  "extensions.plugin_count_one": "{count} 个数字员工",
  "extensions.plugin_count_other": "{count} 个数字员工",
  "extensions.plugins_opencode_header": "数字员工（Plugin）",
  "extensions.remove_from_workspace_button": "从项目空间移除",
  ...
  "settings.feedback_desc": "Tell us what feels smooth and what should improve. Feedback goes into the product queue.",
  "settings.feedback_title": "Improve TashanWork",
  ...
  "settings.opencode_sdk_title": "Tashan CLI link",
  ...
  "settings.openwork_diagnostics_title": "TashanWork service diagnostics",
  "settings.openwork_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.openwork_server_label": "TashanWork service",
  ...
  "settings.runtime_desc": "Status for the local engine and TashanWork service.",
  ...
  "status.limited_mcp_hint": "{count} enterprise tool(s) connected · reconnect for full features",
  "status.limited_mode": "Limited Mode",
  "status.loading_session": "Loading session",
  "status.mcp_connected": "{count} enterprise tool(s) ready",
  ...
  "workspace_list.remove_confirm": "从侧栏移除此项目空间？磁盘上的会话和文件会保留。",
  ...
  "workspace_list.session_streaming": "会话生成中",
