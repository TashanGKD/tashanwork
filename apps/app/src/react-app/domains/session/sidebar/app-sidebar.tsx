  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      ...
      >
        ...
        <div className="px-2 pb-2 pt-2 mac:pt-0">
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton
                className="h-9 rounded-xl bg-sidebar-accent/70 font-medium"
          ...
          <div className="mt-2 grid grid-cols-2 gap-1.5">
            <Button
              variant="ghost"
              size="sm"
              className="h-8 justify-start rounded-xl px-2 text-xs text-muted-foreground hover:text-foreground"
            ...
            <Button
              ...
              size="sm"
              className="h-8 justify-start rounded-xl px-2 text-xs text-muted-foreground hover:text-foreground"
              onClick={() => props.onOpenSettings?.("/settings/extensions")}
            >
            ...
            <Button
              ...
              size="sm"
              className="h-8 justify-start rounded-xl px-2 text-xs text-muted-foreground hover:text-foreground"
              onClick={() => props.onOpenSettings?.("/settings/general")}
            >
            ...
            <CollapsibleContent className="pt-px">
              <SidebarMenuSub>
                {showRemoteConnectionIssue ? (
                  ...
                  <SidebarMenuSubItem>
                    <div className="mx-2 my-2 rounded-2xl border border-sidebar-border/70 bg-sidebar-accent/45 p-3">
                      <div className="flex items-start gap-2">
                        <Sparkles className="mt-0.5 size-4 shrink-0 text-muted-foreground" />
                        <div className="min-w-0">
                          <div className="text-xs font-medium text-sidebar-foreground">还没有会话</div>
                          <div className="mt-1 text-[11px] leading-relaxed text-muted-foreground">
                            选择一个数字员工，或直接创建任务开始当前项目空间。
                          </div>
                        </div>
                      </div>
                      <Button
                        variant="secondary"
                        size="sm"
                        className="mt-3 h-8 w-full rounded-xl"
