...
export function getSettingsTabDescription(tab: SettingsTab) {
  switch (tab) {
    case "ai":
      return "连接企业模型、私有模型或 OpenAI 兼容 API";
    case "preferences":
      return "默认模型、推理显示和上下文压缩";
    case "shell":
      return "品牌、可见入口和应用外壳控制";
    case "permissions":
      return "授权文件夹和本地文件访问边界";
    case "cloud-account":
...
export function getGlobalSettingsTabs(developerMode: boolean): SettingsTab[] {
  const tabs: SettingsTab[] = ["ai", "shell", "appearance", "environment", "advanced", "updates", "recovery"];
