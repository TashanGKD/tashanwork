...
function resolveOpencodeCommand() {
  const explicit = process.env.OPENWORK_TEST_OPENCODE_BIN?.trim();
  if (explicit) return explicit;

  const candidates = process.platform === "win32"
    ? [
        path.join(repoRoot, "apps", "desktop", "resources", "sidecars", "opencode.exe"),
        path.join(repoRoot, "apps", "desktop", "resources", "sidecars", "opencode-x86_64-pc-windows-msvc.exe"),
      ]
    : [
        path.join(repoRoot, "apps", "desktop", "resources", "sidecars", "opencode"),
        path.join(repoRoot, "apps", "desktop", "resources", "sidecars", "opencode-x86_64-unknown-linux-gnu"),
        path.join(repoRoot, "apps", "desktop", "resources", "sidecars", "opencode-aarch64-apple-darwin"),
        path.join(repoRoot, "apps", "desktop", "resources", "sidecars", "opencode-x86_64-apple-darwin"),
      ];
